...
GD,MA,RDFC = st.cache(GD), st.cache(MA), st.cache(RDFC)
...
st.title('Rate-distortion with fixed cardinality (RDFC): _a combination of Blahut-Arimoto and the mapping approach_')
